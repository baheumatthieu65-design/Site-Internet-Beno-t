        ...
        {!submitted ? (
          ...
          <div className="text-center py-8 space-y-4 animate-fadeIn">
            ...
            <p className="text-sm text-[#b8c5ba] max-w-md mx-auto">
              Votre demande pour <strong className="text-[#d4af37]">{selectedJacket.name}</strong> (Taille {size}, Couleur {color}) a bien été enregistrée et transmise à notre atelier (<strong className="text-[#d4af37] font-mono text-xs">{ordersEmail}</strong>). Notre maître tailleur prendra contact avec vous sous 24 heures à l'adresse <strong className="text-white">{email}</strong>.
            </p>
            <div className="pt-4">
              <button
                onClick={() => {
