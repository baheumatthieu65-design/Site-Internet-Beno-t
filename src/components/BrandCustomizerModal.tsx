...
import { getStoredCredentials, saveAdminCredentials } from '../utils/auth';
...
interface BrandCustomizerModalProps {
  ...
  onReset: () => void;
  initialTab?: 'brand' | 'j1' | 'j2' | 'theme' | 'layouts' | 'labels' | 'security';
}
...
export const BrandCustomizerModal: React.FC<BrandCustomizerModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'brand' | 'j1' | 'j2' | 'theme' | 'layouts' | 'labels' | 'security'>(
    initialTab || 'theme'
  );
  ...
  const handleUpdateCredentials = (e: React.FormEvent) => {
    ...
    setSecurityMessage({
      type: 'success',
      text: 'Identifiants administrateur mis à jour avec succès !',
    });
  };
      ...
      <div className="relative w-full max-w-6xl bg-[#141a15] border border-[#3b473e] rounded-3xl shadow-2xl overflow-hidden text-[#e2d5c3] flex flex-col max-h-[92vh]">
        ...
        <div className="flex overflow-x-auto border-b border-[#2a362c] bg-[#111612] px-4 py-2 space-x-1 flex-shrink-0">
          ...
          >
            ...
            <span>7. Sécurité & Sauvegardes</span>
          </button>
        </div>
            ...
            <div className="space-y-8 animate-fadeIn">
              <div className="p-6 rounded-2xl bg-[#1a221c] border border-[#3b4b3e] space-y-4">
                <h4 className="font-serif text-lg text-[#f3ece0] font-semibold flex items-center space-x-2">
                  ...
                  <span>Changement d'Identifiant & Mot de Passe</span>
                </h4>
                ...
                <form onSubmit={handleUpdateCredentials} className="space-y-4 max-w-xl">
                  ...
                  <button
                    type="submit"
                    className="px-5 py-2.5 rounded-xl bg-[#28362b] border border-[#d4af37] text-[#d4af37] hover:bg-[#344638] text-xs uppercase font-bold tracking-wider cursor-pointer"
                  >
              ...
              <div className="p-6 rounded-2xl bg-[#1a221c] border border-[#3b4b3e] space-y-4">
                <h4 className="font-serif text-lg text-[#f3ece0] font-semibold flex items-center space-x-2">
                  ...
                  <span>Sauvegarde & Exportation JSON</span>
                </h4>
                ...
                <div className="flex flex-wrap gap-4">
                  <button
                    ...
                    className="px-4 py-2.5 rounded-xl bg-[#232e26] border border-[#435747] hover:border-[#d4af37] text-xs text-[#f3ece0] font-medium flex items-center space-x-2 cursor-pointer"
                  >
                    <Download className="w-4 h-4 text-[#d4af37]" />
                    <span>Télécharger la Sauvegarde (.JSON)</span>
                  </button>

                  <label className="px-4 py-2.5 rounded-xl bg-[#232e26] border border-[#435747] hover:border-[#d4af37] text-xs text-[#f3ece0] font-medium flex items-center space-x-2 cursor-pointer">
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 rounded-xl bg-red-950/30 border border-red-800/40 text-xs text-red-300 hover:bg-red-900/50 flex items-center space-x-1.5 cursor-pointer ml-auto"
                  >
