...
function applyBlock(block: EditorBlock): void {
  ...
  if (block.fontWeight) html.style.fontWeight = block.fontWeight;
  if (block.fontStyle) html.style.fontStyle = block.fontStyle;
  if (block.textDecoration) html.style.textDecoration = block.textDecoration;
  if (block.whiteSpace) html.style.whiteSpace = block.whiteSpace;
  if (block.lineHeight) html.style.lineHeight = block.lineHeight;
