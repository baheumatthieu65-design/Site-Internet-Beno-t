...
export const GitePage:React.FC<{brandData:BrandConfig;onBackToVitrine:()=>void;onAdmin:()=>void;floatingImages?:FloatingMediaItem[]}>=({brandData,onBackToVitrine,onAdmin,floatingImages=[]})=>{
