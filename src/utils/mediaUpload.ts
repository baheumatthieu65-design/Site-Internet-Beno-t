...
const MAX_BACKGROUND_VIDEO_BYTES = 100 * 1024 * 1024;
...
export async function uploadBackgroundVideo(file: File): Promise<string> {
  ...
  if (file.size > MAX_BACKGROUND_VIDEO_BYTES) throw new Error('La vidéo est trop volumineuse. Utilisez une vidéo de 100 Mo maximum.');
