export const giteConfig = {
  name: "Le Gîte",
  location: "Pyrénées",
  tagline: "Une parenthèse au cœur des Pyrénées.",
  ...
  gallery: [
    ...
    {src:"/gite/gallery-3.jpg",alt:"Chambre"},
  ...
  bookingUrl:"#",
  nearby:[
    {title:"Randonnées",text:"À compléter avec les itinéraires proches du gîte."},
    {title:"Villages",text:"À compléter avec les villages et marchés à découvrir."},
    {title:"Activités",text:"À compléter avec les activités saisonnières."}
  ],
